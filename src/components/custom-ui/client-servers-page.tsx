...
export default function ClientServersPage() {
    ...
    return (
        <div>
            <main className=" h-full relative py-[100px] bg-[#080808] lg:bg-transparent">
                ...
                <div className="relative z-2 min-h-screen">
                    <div ref={contentRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                        <div className="max-w-6xl px-4 md:px-6 mx-auto mb-12">
                            <h2 className="text-[32px] sm:text-3xl xl:text-[48px] font-normal font-instrument-serif text-white">All Servers</h2>
                            <p className="text-2xl font-medium text-[rgba(255,255,255,0.64)] font-darker-grotesque">Browse registered tool endpoints and their pricing, status, and integrations</p>
                        </div>
