...
export function processPriceToAtomicAmount(
    ...
    if (typeof price === "string" || typeof price === "number") {
        ...
        const assetEvm = price.asset;
        maxAmountRequired = price.amount;

        // Always construct with conditional eip712
        asset = {
            address: assetEvm.address as `0x${string}`,
            decimals: assetEvm.decimals,
            eip712: 'eip712' in assetEvm ? assetEvm.eip712 : {
                name: "Unknown Token",
                version: "1"
            }
...
export async function verifyPayment(
    ...
    try {
        ...
        console.log("Decoded", decodedPayment)
