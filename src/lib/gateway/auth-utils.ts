/**
 * Authentication Utilities for latchmcp.app
 * 
 ...
 */
export function generateApiKey(prefix: string = 'latch'): { apiKey: string; keyHash: string } {
...
export function isValidApiKeyFormat(apiKey: string): boolean {
    ...
    return /^latch_[A-Za-z0-9_-]+$/.test(apiKey);
} 