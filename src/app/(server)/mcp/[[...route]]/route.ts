/**
 * Proxy for latchmcp.app API
 * 
 * This module is used to proxy requests to the latchmcp.app API.
...
const forwardRequest = async (c: Context, id?: string, body?: ArrayBuffer, metadata?: { user?: UserWithWallet }) => {
    ...
    headers.set('referer', 'https://latchmcp.app');
    headers.set('origin', 'https://latchmcp.app');
    ...
    headers.set("x-latchmcp-wallet-address", walletAddress);
